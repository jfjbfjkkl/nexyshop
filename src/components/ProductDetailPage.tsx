    ...
    <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {similarGames.map((game) => (
        ...
        >
          ...
          <div className="flex min-h-[92px] items-center justify-between gap-4 px-5 py-5 sm:min-h-[104px] sm:px-5 sm:py-5">
            <div className="min-w-0">
              <strong className="block truncate text-[15px] font-black leading-5 text-[#0A1020] sm:text-base">
                {game.name}
              </strong>
              <span className="mt-2 block text-[11px] font-black uppercase tracking-[0.12em] text-[#6B7A99] sm:text-xs">
                {game.currency}
              </span>
            </div>
